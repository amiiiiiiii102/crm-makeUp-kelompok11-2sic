...
import {
    ...
    User, Mail, CreditCard, Box, Tag, Image, Clock, Info, Heart, Sparkles
} from 'lucide-react';
    ...
    const fetchOrders = useCallback(async () => {
        ...
        try {
            ...
            if (sessionError) {
                ...
                setError("Gagal mendapatkan sesi pengguna: " + sessionError.message);
            ...
            if (!session) {
                setError("Anda harus login untuk melihat pesanan Anda.");
                showNotification("Anda harus login untuk melihat pesanan Anda.", "warning");
                setLoading(false);
                return;
            }
            ...
            const { data, error } = await supabase
                ...
                `)
                .eq('id_user', userId) // Filter pesanan berdasarkan id_user yang sedang login
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 font-medium">Memuat data pesanan Anda...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center mb-4 sm:mb-0">
                            <div className="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-lg mr-3">
                                <ShoppingBag className="w-5 h-5 text-blue-600" /> {/* Icon changed to ShoppingBag */}
                            </div>
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Pesanan Saya</h1>
                                <p className="text-sm text-gray-500">Lihat dan pantau status pesanan Anda</p>
                            </div>
                        </div>
                        <button
                            onClick={fetchOrders}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Cari berdasarkan nama produk atau status..."
                                    value={searchTerm}
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    {/* Email kolom dihapus karena ini tampilan user, dan emailnya sudah pasti email user itu sendiri */}
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        Produk
                                    </th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredOrders.length === 0 ? (
                                    <tr>
                                        <td colSpan="7" className="px-6 py-12 text-center text-gray-500"> {/* colspan disesuaikan */}
